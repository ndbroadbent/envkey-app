...
class UpdatePassword extends React.Component {
  ...
  componentWillUpdate(nextProps, nextState) {
    if (
      this.props.isUpdatingEncryptedPrivkey &&
      !nextProps.isUpdatingEncryptedPrivkey
    ) {
      this.setState({
        ...defaultState,
  ...
  render() {
    return h.form(
      ...
      { ref: 'form', onSubmit: ::this._onSubmit },
      [
        h.fieldset([
          ...
          h(PasswordInput, {
            ...
            strengthUserInputs: R.values(
              R.pick(['email', 'firstName', 'lastName'], this.props.currentUser)
            ),
      ...
      const errString = this.props.updateEncryptedPrivkeyErr.toString(),
        msg =
          errString == 'Invalid passphrase' ? (
            ...
            <span>
              There was a problem setting your new passphrase. If the problem
              persists, please email support@envkey.com.
            </span>
          )
    ...
    if (this.props.isUpdatingEncryptedPrivkey) {
      ...
      const enabled =
        (this.state.passwordValid &&
          ...
          this.state.oldPassword.length >= 10) ||
