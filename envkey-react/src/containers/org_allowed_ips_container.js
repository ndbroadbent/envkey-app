    ...
    return (
      ...
      >
        <fieldset>
          ...
          <p className="msg">
            Allowed networks for requests from the EnvKey App.
          </p>
          <textarea
            type="text"
        ...
        <fieldset>
          ...
          <p className="msg">
            Default allowed networks for Local Development ENVKEYs. These can be
            extended or overriden on an app-specific basis.
          </p>
          <textarea
            type="text"
        ...
        <fieldset>
          ...
          <p className="msg">
            Default allowed networks for Test Server ENVKEYs. These can be
            extended or overriden on an app-specific basis.
          </p>
          <textarea
            type="text"
        ...
        <fieldset>
          ...
          <p className="msg">
            Default allowed networks for Staging Server ENVKEYs. These can be
            extended or overriden on an app-specific basis.
          </p>
          <textarea
            type="text"
        ...
        <fieldset>
          ...
          <p className="msg">
            Default allowed networks for Production Server ENVKEYs. These can be
            extended or overriden on an app-specific basis.
          </p>
          <textarea
            type="text"
            ...
            onChange={e =>
              this.setState({ allowedIpsProduction: e.target.value })
            }
          />
