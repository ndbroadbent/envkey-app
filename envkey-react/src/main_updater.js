    ...
    return (
      <div className="main-updater">
        ...
        <section className="update-info">
          <h1>
            Update <em>Downloaded</em>
          </h1>
          <p>
            EnvKey has auto-updated to{' '}
            <strong>{this.state.versionDownloaded}</strong>. Restart with the
            latest version?
          </p>

          <div className="changelog-container">{this._renderChangelog()}</div>

          <div className="actions">
            <button className="close" onClick={::this._onClose}>
              Not Now
            </button>
            <button className="update" onClick={::this._onUpdate}>
              Restart
            </button>
          </div>
        </section>
