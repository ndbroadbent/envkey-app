...
export const getImportErrors = R.curry((id, state) =>
    db.path('importErrors', id)(state)
  ),
  getImportActionsPending = R.curry(
    (id, state) => db.path('importActionsPending', id)(state) || []
  ),
  getDidOnboardImport = R.curry((id, state) =>
    db.path('didOnboardImport', id)(state)
  ),
