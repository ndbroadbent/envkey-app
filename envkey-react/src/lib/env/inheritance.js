...
export const inheritedShallow = ({ entryKey, inherits, envsWithMeta }) =>
    envsWithMeta[inherits][entryKey],
  ...
  productionInheritanceOverrides = envsWithMeta =>
    R.pipe(
      R.propOr({}, 'production'),
      ...
      R.mapObjIndexed(({ inherits }, entryKey) =>
        inheritedVal({ inherits, entryKey, envsWithMeta })
      )
    )(envsWithMeta)
