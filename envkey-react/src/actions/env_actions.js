...
export const createEntry = createAction(
    CREATE_ENTRY,
    R.pick(['entryKey', 'vals', 'subEnvId']),
    pickMeta
  ),
  updateEntry = createAction(
    UPDATE_ENTRY,
    R.pick(['entryKey', 'newKey', 'subEnvId']),
    pickMeta
  ),
  removeEntry = createAction(
    REMOVE_ENTRY,
    R.pick(['entryKey', 'subEnvId']),
    pickMeta
  ),
  updateEntryVal = createAction(
    UPDATE_ENTRY_VAL,
    R.pick(['entryKey', 'environment', 'update', 'subEnvId']),
    pickMeta
  ),
  ...
  clearPendingEnvUpdate = createAction(
    CLEAR_PENDING_ENV_UPDATE,
    R.always({}),
    R.pick(['parentId', 'envUpdateId'])
  ),
  ...
  removeSubEnv = createAction(
    REMOVE_SUB_ENV,
    R.pick(['environment', 'id']),
    pickMeta
  ),
  renameSubEnv = createAction(
    RENAME_SUB_ENV,
    R.pick(['environment', 'id', 'name']),
    pickMeta
  )
