...
export const closeGeneratedInviteLink = createAction(
    CLOSE_GENERATED_INVITE_LINK,
    R.always({}),
    R.pick(['parentId'])
  ),
  loadInviteRequest = createAction(
    LOAD_INVITE_REQUEST,
    R.pick(['emailVerificationCode']),
    R.pick(['passphrase', 'identityHash'])
  ),
  refreshInviteRequest = createAction(
    REFRESH_INVITE_REQUEST,
    R.pick(['emailVerificationCode']),
    R.pick(['identityHash'])
  ),
