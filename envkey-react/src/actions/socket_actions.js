...
export const socketAction = (type, data) => {
  ...
  socketUserUnsubscribedOrgChannel = createAction(
    SOCKET_USER_UNSUBSCRIBED_ORG_CHANNEL
  ),
  socketUserUnsubscribedObjectChannel = createAction(
    SOCKET_USER_UNSUBSCRIBED_OBJECT_CHANNEL
  ),
  socketUserSubscribedOrgChannel = createAction(
    SOCKET_USER_SUBSCRIBED_ORG_CHANNEL
  ),
  socketUserSubscribedObjectChannel = createAction(
    SOCKET_USER_SUBSCRIBED_OBJECT_CHANNEL
  ),
