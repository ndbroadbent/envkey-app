export const API_SUCCESS = 'envkey/API_SUCCESS',
  ...
  REFRESH_INVITE_REQUEST = 'envkey/REFRESH_INVITE_REQUEST',
  REFRESH_INVITE_API_SUCCESS = 'envkey/REFRESH_INVITE_API_SUCCESS',
  REFRESH_INVITE_SUCCESS = 'envkey/REFRESH_INVITE_SUCCESS',
  REFRESH_INVITE_FAILED = 'envkey/REFRESH_INVITE_FAILED',
  ...
  ACCEPT_INVITE_API_FAILED = 'envkey/ACCEPT_INVITE_API_FAILED',
  ...
  FETCH_CURRENT_USER_UPDATES_REQUEST =
    'envkey/FETCH_CURRENT_USER_UPDATES_REQUEST',
  FETCH_CURRENT_USER_UPDATES_API_SUCCESS =
    'envkey/FETCH_CURRENT_USER_UPDATES_API_SUCCESS',
  FETCH_CURRENT_USER_UPDATES_SUCCESS =
    'envkey/FETCH_CURRENT_USER_UPDATES_SUCCESS',
  FETCH_CURRENT_USER_UPDATES_FAILED =
    'envkey/FETCH_CURRENT_USER_UPDATES_FAILED',
  ...
  UPDATE_NETWORK_SETTINGS_REQUEST = 'envkey/UPDATE_NETWORK_SETTINGS_REQUEST',
  UPDATE_NETWORK_SETTINGS_SUCCESS = 'envkey/UPDATE_NETWORK_SETTINGS_SUCCESS',
  UPDATE_NETWORK_SETTINGS_FAILED = 'envkey/UPDATE_NETWORK_SETTINGS_FAILED',
  ...
  CLEAR_PENDING_ENV_UPDATE = 'envkey/CLEAR_PENDING_ENV_UPDATE',
  ...
  IMPORT_SINGLE_ENVIRONMENT_SUCCESS =
    'envkey/IMPORT_SINGLE_ENVIRONMENT_SUCCESS',
  ...
  INVITE_EXISTING_USER_INVALID_PASSPHRASE =
    'envkey/INVITE_EXISTING_USER_INVALID_PASSPHRASE',
  ...
  HASH_PASSWORD_AND_GENERATE_KEYS_SUCCESS =
    'envkey/HASH_PASSWORD_AND_GENERATE_KEYS_SUCCESS',
  ...
  ACCOUNT_RESET_OPTIONS_REQUEST = 'envkey/ACCOUNT_RESET_OPTIONS_REQUEST',
  ACCOUNT_RESET_OPTIONS_SUCCESS = 'envkey/ACCOUNT_RESET_OPTIONS_SUCCESS',
  ACCOUNT_RESET_OPTIONS_FAILED = 'envkey/ACCOUNT_RESET_OPTIONS_FAILED',
  ...
  VERIFY_CURRENT_USER_PUBKEY_SUCCESS =
    'envkey/VERIFY_CURRENT_USER_PUBKEY_SUCCESS',
  VERIFY_CURRENT_USER_PUBKEY_FAILED =
    'envkey/VERIFY_CURRENT_USER_PUBKEY_FAILED',
  ...
  SOCKET_UNSUBSCRIBE_OBJECT_CHANNEL =
    'envkey/SOCKET_UNSUBSCRIBE_OBJECT_CHANNEL',
  SOCKET_USER_UNSUBSCRIBED_ORG_CHANNEL =
    'envkey/SOCKET_USER_UNSUBSCRIBED_ORG_CHANNEL',
  SOCKET_USER_UNSUBSCRIBED_OBJECT_CHANNEL =
    'envkey/SOCKET_USER_UNSUBSCRIBED_OBJECT_CHANNEL',
  SOCKET_USER_SUBSCRIBED_ORG_CHANNEL =
    'envkey/SOCKET_USER_SUBSCRIBED_ORG_CHANNEL',
  SOCKET_USER_SUBSCRIBED_OBJECT_CHANNEL =
    'envkey/SOCKET_USER_SUBSCRIBED_OBJECT_CHANNEL',
  SOCKET_UPDATE_ENVS_STATUS = 'envkey/SOCKET_UPDATE_ENVS_STATUS',
  PROCESSED_SOCKET_UPDATE_ENVS_STATUS =
    'envkey/PROCESSED_SOCKET_UPDATE_ENVS_STATUS',
  ...
  BILLING_UPDATE_SUBSCRIPTION_REQUEST =
    'envkey/BILLING_UPDATE_SUBSCRIPTION_REQUEST',
  BILLING_UPDATE_SUBSCRIPTION_SUCCESS =
    'envkey/BILLING_UPDATE_SUBSCRIPTION_SUCCESS',
  BILLING_UPDATE_SUBSCRIPTION_FAILED =
    'envkey/BILLING_UPDATE_SUBSCRIPTION_FAILED',
  BILLING_FETCH_INVOICE_LIST_REQUEST =
    'envkey/BILLING_FETCH_INVOICE_LIST_REQUEST',
  BILLING_FETCH_INVOICE_LIST_SUCCESS =
    'envkey/BILLING_FETCH_INVOICE_LIST_SUCCESS',
  BILLING_FETCH_INVOICE_LIST_FAILED =
    'envkey/BILLING_FETCH_INVOICE_LIST_FAILED',
  BILLING_FETCH_INVOICE_PDF = 'envkey/BILLING_FETCH_INVOICE_PDF',
  BILLING_FETCH_INVOICE_PDF_REQUEST =
    'envkey/BILLING_FETCH_INVOICE_PDF_REQUEST',
  BILLING_FETCH_INVOICE_PDF_SUCCESS =
    'envkey/BILLING_FETCH_INVOICE_PDF_SUCCESS',
