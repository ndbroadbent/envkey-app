...
const config = {
  ...
  collaborators: [
    ...
    30.8,
    39.6,
    { objectPermissionPath: ['appUser', 'read'] },
  ],
  ...
  settings: [
    ...
    33,
    33,
    { objectPermissionPath: ['updateSettings'] },
  ],
  ...
  firewall: [
    ...
    28,
    34,
    { objectPermissionPath: ['updateNetworkSettings'] },
  ],
  billing: [
    'billing',
    'Billing',
...
const SelectedTabs = props => {
  ...
  const renderTab = (
    [
      ...
      imgW,
      imgH,
      { permissionPath, objectPermissionPath, permissionFn } = {},
    ],
    i
  ) => {
    ...
    if (
      permissionPath &&
      (!permissions || !R.path(permissionPath, permissions))
    ) {
      hasPermission = false
    }
    if (
      objectPermissionPath &&
      (!objectPermissions || !R.path(objectPermissionPath, objectPermissions))
    ) {
      hasPermission = false
    }
