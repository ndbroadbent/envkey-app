...
const KeyGeneratable = AssociationRow =>
  class extends AssociationRow {
    _showKeyGenerated() {
    ...
    _classNames() {
      return super
        ._classNames()
        .concat([this._showKeyGenerated() ? ' key-generated' : ''])
    }

    _renderContents() {
      return super._renderContents().concat([this._renderKeyGenerated()])
    }
