...
const AccountMenu = ({
  ...
  const renderMenuRow = (label, path, img, opts = {}) => {
      return (
        <Link
          to={opts.disabled ? '' : path}
      ...
      return (
        <section className="basic-menu">
          ...
          <div className="row-bottom">
            ...
            <span className="col-right toggle" onClick={e => onToggle()}>
      ...
      if (isOpen) {
        return (
          <section className="menu-body">
            ...
            {orgRoleIsAdmin(currentUser.role)
              ? renderMenuRow(
                  'My Organization',
            ...
            {renderMenuRow('Sign Out', '/sign_out', 'signout-black.png', {
              onClick: e => {
                e.preventDefault()
                logout()
              },
