...
const OnboardSlider = props => {
    ...
    return h.div('.onboard-slider', { className }, [selectedChild])
  },
  varAddedSlide = (props, isOwner = false) =>
    h.div('.slide-1', [
      h.h1('.code', [
        `${R.path(['lastAddedEntry', 'entryKey'], props)}=`,
        h.em('.orange', 'ENCRYPTED_AND_SAVED'),
      ]),
...
export const OrgOwnerAppEnvSlider = props =>
    h(OnboardSlider, { ...props, className: 'app-env-slider' }, [
      h.div('.slide-0', [
  ...
  AdminAppKeysSlider = props =>
    h(OnboardSlider, { ...props, className: 'app-keys-slider' }, [
      h.div('.slide-0', [
        ...
        h.p(
          'Let’s start with your development environment. Go ahead and generate your development key.'
        ),
      ]),
      ...
      h.div('.slide-1', [
        ...
        h.p(
          'That means a new OpenPGP keypair was generated and your config was encrypted with the public key. '
        ),

        h.p(
          'Follow the instructions in the blue box to give yourself development access. '
        ),
  ...
  AppCollaboratorsSlider = props =>
    h(OnboardSlider, { ...props, className: 'app-collaborators-slider' }, [
      h.div('.slide-0', [
      ...
      h.div('.slide-1', [
        ...
        h.p([
          ...
          h.a(
            '.blue',
            { href: 'mailto:support@envkey.com', onClick: openLinkExternal },
            'support@envkey.com'
          ),
          ' -- or post an issue on ',
          h.a(
            '.blue',
            {
              href: 'https://github.com/envkey/envkey-ui/issues',
