...
const SocketEditable = Cell =>
  class extends Cell {
    _classNames() {
      return super
        ._classNames()
        .concat([
          this.props.socketUserEditingEntryVal
            ? 'socket-editing-entry-val'
            : '',
        ])
    }
